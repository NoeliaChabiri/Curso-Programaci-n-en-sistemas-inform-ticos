...
int main()
{
    char nombreArticulo[100]; // Variable para almacenar el nombre del artículo (incorrecta, debería ser un arreglo de caracteres).
    ...
    printf("Usted compro %i unidades de %s, y debe pagar: %.2f€ ", cantArt , total, nombreArticulo);
